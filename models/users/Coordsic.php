...
class Coordsic extends User {
    ...
    static function ajouterReleve($num_serie, $date_releve, $total_112, $total_113, $total_123, $type_releve): bool
    {
        $champs = `()`;
        $query = "INSERT INTO compteurs
        (num_serie, bdd, date_releve, 112_total, 113_total, 123_total, modif_par, type_releve)
        VALUES
        (:num_serie, :bdd, :date_releve, :112_total, :113_total, :123_total, :modif_par, :type_releve)";
