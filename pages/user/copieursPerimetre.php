...
<div class="container">
    ...
    <div class="mt-4 row g-3 align-items-center mb-2">
        ...
        <div class="col-auto">
            <input type="text" name="num_serie" class="form-control" id="table_search_imprimantes" placeholder="Insérer son numéro de série">
        </div>
    </div>

    <table id="table_content_imprimantes" class="table table-striped personalTable" style="width:100%">
