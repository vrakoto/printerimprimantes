<div class="d-flex justify-content-between align-items-center mt-5 mb-3">
    <div id="pagination">
        ...
        <?php if ($url === 'compteurs_perimetre'): ?>
            ...
            <a class="btn btn-secondary text-white" href="<?= $router->url('view_import_counters') ?>"><i class="fa-solid fa-plus"></i><i class="fa-solid fa-file mx-2"></i> Ajouter massivement des compteurs</a>
        <?php endif ?>
    </div>
