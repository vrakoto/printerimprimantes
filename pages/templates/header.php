<div class="mt-2" id="header">
    ...
    <a href="?page=<?= $page . '&' . $fullURL ?>&download_csv=true" class="btn btn-success" title="Télécharger les données en CSV"><i class="fa-solid fa-download"></i> Télécharger les données</a>
